...
export default function BuyersSection() {
  return (
    <section className="py-20 bg-gradient-to-b from-white to-amber-50" id="buyers">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-gray-900">For Buyers</h2>
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-2xl font-semibold mb-6 text-gray-900">The Challenges Consumers Face</h3>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-2xl font-semibold mb-6 text-gray-900">How ShareBeez Solves These Issues</h3>
            <div className="space-y-4">
