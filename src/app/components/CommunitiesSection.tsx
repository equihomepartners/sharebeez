...
export default function CommunitiesSection() {
  return (
    <section className="py-20 bg-gradient-to-b from-amber-50 to-white" id="communities">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-gray-900">For Communities & Organizations</h2>
