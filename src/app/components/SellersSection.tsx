  ...
  return (
    <section className="py-20 bg-white" id="sellers">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-black">For Sellers</h2>
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <h3 className="text-2xl font-semibold mb-6 text-black">Why Sell on ShareBeez?</h3>
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <h3 className="text-2xl font-semibold mb-6 text-black">QR-Based Order Tracking for Sellers</h3>
